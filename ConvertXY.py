...
output = xyConv.XYtoSky_pars('/home/ian/Documents/GREAT03/sample/g1.fits[0]', None, None, '/home/ian/Documents/GREAT03/sample/galaxy_catalog-000.fits', 'x,y', xyConv.yes, 'IDCTAB')
sys.stdout = sys.__stdout__

# LOAD AND SAVE THE G03 GALAXY IDS
f2 = pyfits.open('/home/ian/Documents/GREAT03/sample/galaxy_catalog-000.fits')
tbdata = f2[1].data
idData = []
